...
export default function PrivacyPolicyPage() {
  const content = LEGAL_PAGES.privacy_policy;
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-16 pt-8 border-t border-gray-200">
              <h3 className="font-bold text-gray-800 mb-3">Questions about this policy?</h3>
              <p className="text-gray-700 mb-4">
                Contact us at{" "}
                <a href="mailto:privacy@krishroyalorganics.com" className="text-primary-green hover:underline">
                  privacy@krishroyalorganics.com
                </a>
              </p>
              <a
                href="/contact"
